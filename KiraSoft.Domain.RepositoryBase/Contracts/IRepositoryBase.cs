...
namespace KiraSoft.Domain.RepositoryBase.Contracts
{
            ...
            where TEntity : IBaseEntity<TKey>
    {
        ...
        IEnumerable<TEntity> GetAllMatching(Expression<Func<TEntity, bool>> filter, params string[] includes);
        IEnumerable<TEntity> GetAllMatchingPaged(Expression<Func<TEntity, bool>> filter, int pageNumber, int pageSize, params string[] includes);

        //  Get Async
        Task<TEntity> GetAsync(TKey entityId);
        Task<IEnumerable<TEntity>> GetAllAsync();
        Task<IEnumerable<TEntity>> GetAllAsync(params string[] includes);
        Task<IEnumerable<TEntity>> GetAllMatchingAsync(Expression<Func<TEntity, bool>> filter, params string[] includes);
        Task<IEnumerable<TEntity>> GetAllMatchingPagedAsync(Expression<Func<TEntity, bool>> filter, int pageNumber, int pageSize, params string[] includes);
